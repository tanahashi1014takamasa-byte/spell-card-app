...
フィジカルペナルティ系スペルカードは、
自分自身に使用することで「制約と誓約」を発動することができる。

制約（フィジカルペナルティ）を自分に課すことで、ベット倍率を上昇させる。
制約を課したら、どちらかの誓約を選択しなければならない。

【誓約A】
・ベット倍率が×2になる。
・そのゲーム中、そのスペルカードを自分自身に使用することはできなくなる。
・相手への使用は可能。

【誓約B】
・ベット倍率が×3になる。
・そのゲーム中、そのスペルカードは使用不可能になる。
  </div>
)}
